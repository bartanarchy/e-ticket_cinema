...
<head>
    ...
    <title>Login - Cinema Ticket</title>
...
<body>
    <div class="card p-4" style="width: 420px;">
        ...
        <p class="text-center text-muted-light mb-4" style="font-size: 0.85rem;">Masuk untuk memesan tiket</p>

        <?php if ($success): ?>
            <div class="alert border-0 mb-3" style="background-color: rgba(25,135,84,0.2); color: #75e0a7;">
                ✅ <?= $success ?>
            </div>
        <?php endif; ?>
        ...
        <p class="text-center mt-3 text-muted-light">Belum punya akun?
